...
public class TestVehiculos {
	...
	public void testListaMezclada() {
		...
		while ( it.hasNext() ){
			...
			if( v instanceof VehiculoElectrico ){ //Si este objeto es una instancia de la clase VehiculoElectrico
				((VehiculoElectrico) v).checkBateria(); //Casteo ((VehiculoElectrico) v)...
			}else if( v instanceof VehiculoGasolina){
				((VehiculoGasolina) v).checkInyector(); //Casteo ((VehiculoGasolina) v)...
			}else{
