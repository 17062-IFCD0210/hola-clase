...
<section>
	...
	<article>	
		...
		<form action="ControladorPersona" method="post" novalidate>
			...
			<fieldset>
				...
				<label for="mensaje"></label><br>
				 -->
				<!-- Otra forma en vez de lo de arriiba en Java -->
				<label for="mensaje"> ${requestScope.msg} </label><br> <!-- en código Expression Language -->
